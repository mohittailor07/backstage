...
import { LoggerService, CacheServiceOptions, CacheService, ServiceRef, DatabaseService, LifecycleService, PluginMetadataService, DiscoveryService, UrlReaderService, ReadTreeResponse, ReadUrlOptions, ReadUrlResponse, ReadTreeOptions, SearchOptions, SearchResponse, TokenManagerService } from '@backstage/backend-plugin-api';
...
import { AzureIntegration, BitbucketCloudIntegration, BitbucketIntegration, BitbucketServerIntegration, GerritIntegration, GithubIntegration, GithubCredentialsProvider, GitLabIntegration, GiteaIntegration, AwsS3Integration } from '@backstage/integration';
...
declare const legacyPlugin: (name: string, createRouterImport: Promise<{
    default: LegacyCreateRouter<TransformedEnv<{
        ...
        config: _backstage_backend_plugin_api.ConfigService;
 ...
 */
declare const SingleHostDiscovery: typeof HostDiscovery;
