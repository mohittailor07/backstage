...
const SearchPage$1 = searchPlugin.provide(
  createRoutableExtension({
    name: "SearchPage",
    component: () => import('./index-f834399b.esm.js').then((m) => m.SearchPage),
...
const SidebarSearchModal = searchPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./index-0a67f525.esm.js').then(
...
const HomePageSearchBar = searchPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./index-53c75597.esm.js').then((m) => m.HomePageSearchBar)
    }
  })
);
...
//# sourceMappingURL=index-72149ea7.esm.js.map
